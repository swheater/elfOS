...
#define ILI9320_ENTRYMODE_INST                      (0x0002)
#define ILI9320_LCDDRIVINGCONTROL_INST              (0x0003)
...
static void ili9320StartInitialSequence(void)
{
    ...
    ili9320SetRegister(ILI9320_ENTRYMODE_INST,            0x0700);
    ili9320SetRegister(ILI9320_LCDDRIVINGCONTROL_INST,    0x1030);
...
void ili9320Test(void)
{
    ...
    {
        ili9320SetIndexRegister(ILI9320_DRIVERCODEREAD_INST);
