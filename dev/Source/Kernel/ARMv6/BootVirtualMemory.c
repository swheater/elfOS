...
static UnsignedWord32 kernel_phyDevice203PageTable[PAGETABLESIZE] __attribute__((aligned(0x400)));
...
void kernel_boot_virtualMemorySetup(void)
{
    ...
    for (index = 0; index < PAGETABLESIZE; index++)
        kernel_phyDevice203PageTable[index] = ((0x20300000 + (index << 12)) & 0xFFFFF000) | 0x032;
    ...
    kernel_phyContainerTranslationTable[0x203] = (((unsigned int) kernel_phyDevice203PageTable) & 0xFFFFFFC0) | D00_L1DESCDOMAIN | NONSECURE_L1DESCPERM | PAGE_L1DESCTYPE;
